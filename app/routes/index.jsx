  ...
  return (
    ...
    >
      <main>
        ...
        <Typography sx={{ marginBottom: '2em' }} variant='body1'>Discover books in your favourite genre which are a suitable lenght. Search through 100,000 books to find a book which suits your needs - filter by rating, genre and page count</Typography>
